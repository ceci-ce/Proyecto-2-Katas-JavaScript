//Dada una lista de álbumes de música, utiliza un bucle para sumar todas las duraciones solo de los álbumes de rock y luego imprime el total de estas
...
let totalRockAlbums = 0;

for(const album of albums){
    if(album.genre === 'Rock'){
        totalRockAlbums += album.duration
    }
}

console.log(totalRockAlbums);